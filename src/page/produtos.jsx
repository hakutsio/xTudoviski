            ...
            <CssBaseline>
                <Container sx={{width: "100%"}}> 
                    <Box sx={{ width: "50%", bgcolor: "#ffffffff", height: '40vh', padding: '1rem', marginTop: '1rem'}} >   
                        ...
                        <TextField id="standard-basic" label="Codigo Produto" variant="standard" size="small" sx={{width: "30%", marginRight: "40%"}}/>
                        <TextField id="outlined-basic" label="Valor" variant="outlined" size="small" sx={{width: "30%"}}/>
                        <TextField id="outlined-basic" label="Produto" variant="outlined" size="small" sx={{width: "100%", marginTop: "1rem"}} />
                    </Box>
                </Container>
            </CssBaseline>
        </React.Fragment>
